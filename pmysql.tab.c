...
#line 3081 "pmysql.tab.c"
    break;

  case 199: /* stmt: replace_stmt  */
#line 684 "pmysql.y"
                   { emit("STMT"); }
#line 3087 "pmysql.tab.c"
    break;
...
#line 3105 "pmysql.tab.c"
    break;

  case 203: /* stmt: update_stmt  */
#line 705 "pmysql.y"
                  { emit("STMT"); }
#line 3111 "pmysql.tab.c"
    break;
...
#line 731 "pmysql.y"
       { if ((yyvsp[-1].subtok) != 4) { yyerror("bad update  assignment to %s.$s", (yyvsp[-4].strval), (yyvsp[-2].strval)); 
          YYERROR; }
         emit("ASSIGN %s.%s", (yyvsp[-4].strval), (yyvsp[-2].strval)); free((yyvsp[-4].strval)); free((yyvsp[-2].strval)); (yyval.intval) = 1; }
#line 3164 "pmysql.tab.c"
    break;

  case 212: /* stmt: create_database_stmt  */
#line 738 "pmysql.y"
                           { emit("STMT"); }
#line 3170 "pmysql.tab.c"
    break;
...
#line 3195 "pmysql.tab.c"
    break;

  case 217: /* stmt: create_table_stmt  */
#line 755 "pmysql.y"
                        { emit("STMT"); }
#line 3201 "pmysql.tab.c"
    break;
